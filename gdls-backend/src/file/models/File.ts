...
import { updateUserRelation,updateDumbHatUserRelation } from './update-operations/file-update-operations';
...
export class File implements IAuthorizable {
  ...
  @OneToOne(() => User, (user) => user.avatar , {"nullable":true,"onDelete":"SET NULL"})
  @Field(() => User , {"nullable":true})
  @JoinColumn()
  public user: Promise<User | undefined | null>;

  @OneToOne(() => User, (user) => user.dumbHatPicture , {"nullable":true,"onDelete":"SET NULL"})
  @Field(() => User , {"nullable":true})
  @JoinColumn()
  public dumbHatUser: Promise<User | undefined | null>;
  ...
  public async update(input: FileCreateInput | FileEditInput | FileNestedInput, context: IRequestContext) {
    const { user, dumbHatUser, ...data } = input;
    if (noChange(input)) {
      return this;
    }
    ...
    Object.assign(this, { ...data, slug: 'test' });

    await updateUserRelation(this, user, context);
    await updateDumbHatUserRelation(this, dumbHatUser, context);
